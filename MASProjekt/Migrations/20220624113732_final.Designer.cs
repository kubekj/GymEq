...
namespace MASProjekt.Migrations
{
    ...
    [Migration("20220624113732_final")]
    partial class final
    {
            ...
            modelBuilder.Entity("MASProjekt.Models.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            End = new DateTime(2022, 6, 24, 11, 37, 32, 220, DateTimeKind.Utc).AddTicks(5650),
                            Start = new DateTime(2022, 6, 24, 11, 37, 32, 220, DateTimeKind.Utc).AddTicks(5650),
                            Title = "Zamba",
                            TrainerId = 1
                        });
                });
            ...
            modelBuilder.Entity("MASProjekt.Models.Agreement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdPerson = 1,
                            AgreementType = 1,
                            ResignationDate = new DateTime(2022, 6, 24, 11, 37, 32, 220, DateTimeKind.Utc).AddTicks(5660),
                            SignUpDate = new DateTime(2022, 6, 24, 11, 37, 32, 220, DateTimeKind.Utc).AddTicks(5660)
                        });
                });
            ...
            modelBuilder.Entity("MASProjekt.Data.ClubMember", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AmountPayed = 120044f,
                            AmountToPay = 1000f,
                            Birthday = new DateTime(2022, 6, 24, 11, 37, 32, 220, DateTimeKind.Utc).AddTicks(5670),
                            Discount = 0f,
                            UniqueNumber = 602695752
                        });
                });
